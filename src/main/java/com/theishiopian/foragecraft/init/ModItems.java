...
import com.theishiopian.foragecraft.items.*;
...
public class ModItems
{
    ...
    public static void init()
    {
        ...
        spaghetti = new Spaghetti(11, 20, false);//keep those wolves away from my spaghet!
        leek_seeds = (Modseeds) new Modseeds(ModBlocks.leek_block, Blocks.FARMLAND).setTranslationKey("leek_seeds").setRegistryName("leek_seeds");
